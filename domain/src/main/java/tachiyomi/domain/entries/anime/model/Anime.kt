...
data class Anime(
    ...
    val episodeGridSize: Int
        get() = ((episodeFlags and EPISODE_GRID_DISPLAY_SIZE_MASK) shr EPISODE_GRID_DISPLAY_SIZE_BIT_OFFSET).toInt()
    ...
    companion object {
        ...
        const val EPISODE_DISPLAY_GRID = 0x00200000L
        const val EPISODE_DISPLAY_MASK = 0x00300000L

        const val EPISODE_GRID_DISPLAY_SIZE_BIT_OFFSET = 22
        const val EPISODE_GRID_DISPLAY_SIZE_MASK = 0x03C00000L
