...
private val INDICATOR_ICON_FRACTION = 0.65f
private val INDICATOR_STROKE_FRACTION = 0.05f
private val INDICATOR_ARROW_OFFSET = 7.dp
...
private fun NotDownloadedIndicator(
    ...
    Box(
        ...
        Icon(
            ...
            modifier = Modifier.size(size * INDICATOR_ICON_FRACTION),
...
private fun DownloadingIndicator(
    ...
    Box(
        ...
        val indicatorSize = size * INDICATOR_ICON_FRACTION
        val indicatorPadding = size * INDICATOR_STROKE_FRACTION
        if (indeterminate) {
        ...
        Icon(
            ...
            modifier = Modifier.size(indicatorSize - INDICATOR_ARROW_OFFSET),
            tint = arrowColor,
        )
    }
}
